    ...
    public static void Option1()
        {
            ...
            {
                int score = 0;
                SoundPlayer player = new SoundPlayer("Envici November - Original Instrument (1).wav");
                Console.Clear();
                player.PlayLooping();
                Console.WriteLine("\n\n\n\n\n\n\n\n\n\n\n\n");
                ...
                Console.WriteLine("\t\t\t\t\t\t\t\t      Choose any number you prefer from the difficulties list below. ( Ex: 1 or 123 or 312)");
                Console.ResetColor();
                ...
                {
                    Console.Clear();
                    Class1.Option1(); //option1 is where the user choose what type of difficulties desire
                }
                ...
                if (finalchoise.Contains('5')) //  if the user choose the hard words type
                {
                    player.Stop();
                    Console.Clear();
                    Program.Main();
                ...
                storeStory[0] = $"{upper[0]} {number[0]} {upper[1]}{punctuation[0]} {upper[2]} saw the bus{punctuation[2]} {punctuation[4]}{upper[3]}{punctuation[1]}{punctuation[4]} he yelled{punctuation[2]} {upper[4]} doors closed{punctuation[2]} {punctuation[4]}{upper[5]}{punctuation[1]}{punctuation[4]} {upper[6]} then{punctuation[0]} the bus driver noticed him{punctuation[2]} {punctuation[4]}{upper[7]}{punctuation[1]} {number[1]} seconds{punctuation[1]}{punctuation[4]} {upper[2]} leapt on board{punctuation[2]} {upper[8]}{punctuation[1]} {upper[9]} in time{punctuation[2]} ";
                storeStory[1] = $"{punctuation[4]}{upper1[0]}{punctuation[4]}m {number1[0]} today{punctuation[1]}{punctuation[4]} {upper1[1]} shouted{punctuation[2]} {punctuation[4]}{upper1[2]} for a party{punctuation[1]}{punctuation[4]} {upper1[3]} friends cheered{punctuation[2]} {upper1[4]} had {number1[1]} balloons{punctuation[0]} {number1[2]} cakes{punctuation[0]} and {number1[3]} gifts{punctuation[2]} {punctuation[4]}{upper1[5]} is the {upper1[6]}{punctuation[1]}{punctuation[4]} {upper1[1]} exclaimed{punctuation[0]} smiling widely{punctuation[2]} {punctuation[4]}{upper1[7]}{punctuation[4]}s make it unforgettable{punctuation[1]}{punctuation[4]}";
                storeStory[2] = $"{upper2[0]} {number2[0]} {upper2[1]}{punctuation[0]} {upper2[2]} decided to try something new{punctuation[2]} {punctuation[4]}{number2[1]} steps{punctuation[1]}{punctuation[4]} she told herself{punctuation[2]} First{punctuation[0]} she opened the book{punctuation[2]} {upper2[3]}{punctuation[0]} she read{punctuation[2]} {punctuation[4]}{number2[2]} chapter down{punctuation[0]} {number2[3]} more to go{punctuation[1]}{punctuation[4]} {upper2[4]} midnight{punctuation[0]} success{punctuation[1]}";
                storeStory[3] = $"{punctuation[4]}{upper3[0]} have {number3[0]} dollars{punctuation[1]}{punctuation[4]} {upper3[1]} said proudly{punctuation[2]} {punctuation[4]}But{punctuation[0]} {number3[1]} bills are missing{punctuation[2]}{punctuation[4]} {upper3[2]} searched everywhere{punctuation[2]} {punctuation[4]}{upper3[3]} them{punctuation[1]}{punctuation[4]} he exclaimed{punctuation[0]} counting{punctuation[2]} {punctuation[4]}{upper[4]}{punctuation[2]}{punctuation[2]}{punctuation[2]} only {number3[2]}{punctuation[6]} {upper3[5]} are the others{punctuation[6]}{punctuation[4]} {upper3[6]} hunt continued until midnight{punctuation[1]}";
                storeStory[4] = $"{punctuation[4]}{upper4[0]} {number4[0]} minutes left{punctuation[1]}{punctuation[4]} {upper4[1]} shouted{punctuation[0]} looking at the clock{punctuation[2]} {upper4[2]} team was down by {number4[1]} points{punctuation[2]} {upper[10]} {number4[2]} seconds to go{punctuation[0]} he shot{punctuation[2]} {upper4[4]}{punctuation[1]} {punctuation[4]}{upper4[5]}{punctuation[1]} {upper4[6]}{punctuation[1]}{punctuation[4]} The crowd went wild{punctuation[2]}";
                storeStory[5] = $"{punctuation[4]}{upper6[0]} {number6[0]}{punctuation[0]} {upper6[1]} ran {number2[0]} miles faster than ever{punctuation[1]} {upper6[2]} at mile {number2[1]}{punctuation[0]} he saw her: {number6[1]} woman{punctuation[0]} waiting{punctuation[2]} {punctuation[4]}{upper6[3]} it your turn?{punctuation[4]} she asked{punctuation[2]} {upper6[4]} nodded{punctuation[2]} {upper6[5]} never stops moving{punctuation[2]}{punctuation[4]}";
                storeStory[6] = $"{punctuation[4]}{upper[0]} {number7[0]} {upper7[0]}{punctuation[0]} {upper1[1]} found the note: {punctuation[4]}{number2[1]} steps ahead{punctuation[0]} {number2[0]} miles to go{punctuation[2]}{punctuation[4]} {upper2[3]} only {number6[1]} flashlight{punctuation[0]} she ran{punctuation[2]} {upper[4]} wind howled{punctuation[0]} the trees whispered{punctuation[0]} but she knew—time was running out{punctuation[2]}{punctuation[4]}";
                storeStory[7] = $"{punctuation[4]}{number2[2]} weeks{punctuation[0]} {number2[0]} days{punctuation[0]} {number2[1]} hours: the countdown had begun{punctuation[2]} {upper[4]} rocket launched at {number8[0]} {upper7[0]}{punctuation[0]} hurtling towards {upper8[0]}{punctuation[2]} {upper[4]} crew cheered{punctuation[2]} {punctuation[4]}{upper8[1]} are making history{punctuation[0]}{punctuation[4]} {upper8[2]} declared{punctuation[2]} {upper8[3]} smiled{punctuation[2]}{punctuation[4]}";
                storeStory[8] = $"{punctuation[4]}{number9[0]} {upper[1]}{punctuation[0]} and the clock struck{punctuation[2]} {number2[1]} decisions were left{punctuation[2]} {number2[0]} minutes until the meeting began{punctuation[2]} {upper9[0]} heart raced—could she handle it? {upper[4]} boardroom was waiting{punctuation[2]} {upper[4]} fate of {number9[1]} employees was at stake{punctuation[2]}{punctuation[4]}";
                ...
                if (error >= storyWords.Length * 1.0)
                {
                    score += 0;
                }
